...
\begin{table}
  ...
  \caption{
    Overall accuracies of existing approaches. \(N\) = total number of subjects, \(N_{\text{ASD}}\)
    ...
    Neural Network (linear layers). RF = Random forest. SVM = support vector machine. ROI-FC =
    ROI-based FC matrix.  CC-200/400 = Cameron-Craddock 200/400. HO = Harvard-Oxford. OA = Overall
    Accuracy.
  }
  \normalsize
\end{table}
