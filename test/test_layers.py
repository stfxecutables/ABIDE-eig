...
from src.analysis.predict.deep_learning.models.layers.conv import Conv3dSame, InputConv, ResBlock3d
...
class TestConv:
    def test_conv_input_shapes(self, capsys: CaptureFixture) -> None:
        K = [1, 2, 3, 4, 5, 7]
        S = [1, 2]
        P = [1, 2, 3, 4, 5]
        D = [1, 2, 3]
    ...
    def test_conv_padding(self, capsys: CaptureFixture) -> None:
        K = [1, 2, 3, 4, 5, 7]
        D = [1, 2, 3]
        EVENS = [1, 1, 32, 32, 32]
        ODDS = [1, 1, 33, 33, 33]
    ...
    def test_resblock(self, capsys: CaptureFixture) -> None:
